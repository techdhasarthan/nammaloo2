...
const getStatusFromHoursString = (hoursStr, currentTime) => {
...
export const getStatusColor = (workingHours) => {
  if (!workingHours) {
...
export const getStatusText = (workingHours) => {
  if (!workingHours) {
...
export const isCurrentlyOpen = (workingHours) => {
  if (!workingHours) {
...
export const getDetailedHours = (workingHours) => {
  if (!workingHours) {
    return ['Hours not available'];
  }
